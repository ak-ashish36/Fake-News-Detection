...
const NewsItem = (props) => {
    ...
    return ( <
        ...
        div > { " " } <
        img src = {!imageUrl ?
            "https://dd7tel2830j4w.cloudfront.net/f1550965374835x373311315531899650/newsapi.svg" : imageUrl
        }
        style = {
            { height: "20em" }
        }
        ...
        /a>{" "} <
        div style = {
            { display: "inline", position: "absolute", right: "-19rem" }
        }
        className = "card-text container" > {!loading ? ( <
                >
                { " " } <
